...
public class BinImage extends Component {
	...
	public static int color(int i){
		switch(i){
		case 0: return Color.BLUE.getRGB();
		case 1: return Color.GREEN.getRGB();
		case 3: return Color.RED.getRGB();
		case 4: return Color.YELLOW.getRGB();
		case 5: return Color.CYAN.getRGB();
		case 6: return Color.GRAY.getRGB();
		case 7: return Color.MAGENTA.getRGB();
		}
